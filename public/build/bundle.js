    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "desktop svelte-cvksa0");
    			add_location(div0, file, 43, 0, 1226);
    			attr_dev(div1, "class", "mobile svelte-cvksa0");
    			add_location(div1, file, 47, 0, 1289);
    			attr_dev(h1, "class", "svelte-cvksa0");
    			add_location(h1, file, 53, 2, 1381);
    			attr_dev(p0, "class", "deck svelte-cvksa0");
    			add_location(p0, file, 54, 2, 1415);
    			attr_dev(p1, "class", "byline svelte-cvksa0");
    			add_location(p1, file, 55, 2, 1510);
    			attr_dev(div2, "class", "header svelte-cvksa0");
    			...
    			attr_dev(h20, "class", "svelte-cvksa0");
    			add_location(h20, file, 63, 2, 2310);
    			attr_dev(div3, "class", "desktop svelte-cvksa0");
    			add_location(div3, file, 66, 3, 2396);
    			attr_dev(div4, "class", "mobile svelte-cvksa0");
    			add_location(div4, file, 70, 3, 2463);
    			attr_dev(div5, "class", "legendSVG svelte-cvksa0");
    			add_location(div5, file, 65, 2, 2369);
    			add_location(strong1, file, 77, 25, 2572);
    			attr_dev(h21, "class", "svelte-cvksa0");
    			add_location(h21, file, 77, 2, 2549);
    			attr_dev(div6, "class", "desktop svelte-cvksa0");
    			add_location(div6, file, 80, 3, 2644);
    			attr_dev(div7, "class", "mobile svelte-cvksa0");
    			add_location(div7, file, 83, 3, 2710);
    			attr_dev(div8, "class", "legendSVG svelte-cvksa0");
    			add_location(div8, file, 79, 2, 2617);
    			attr_dev(div9, "class", "section1 svelte-cvksa0");
    			add_location(div9, file, 58, 1, 1559);
    			attr_dev(h22, "class", "svelte-cvksa0");
    			add_location(h22, file, 91, 2, 2823);
    			attr_dev(div10, "class", "desktop svelte-cvksa0");
    			add_location(div10, file, 93, 2, 2922);
    			attr_dev(div11, "class", "mobile svelte-cvksa0");
    			add_location(div11, file, 97, 2, 2985);
    			add_location(strong2, file, 101, 33, 3086);
    			attr_dev(h23, "class", "svelte-cvksa0");
    			add_location(h23, file, 101, 2, 3055);
    			attr_dev(p5, "class", "body");
    			add_location(p5, file, 103, 2, 3169);
    			attr_dev(div12, "class", "desktop svelte-cvksa0");
    			add_location(div12, file, 105, 2, 3382);
    			attr_dev(div13, "class", "mobile svelte-cvksa0");
    			...
    			attr_dev(video, "class", "svelte-cvksa0");
    			add_location(video, file, 119, 2, 4156);
    			attr_dev(div14, "class", "section2 svelte-cvksa0");
    			add_location(div14, file, 90, 1, 2798);
    			attr_dev(main, "class", "svelte-cvksa0");
