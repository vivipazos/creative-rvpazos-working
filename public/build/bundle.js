    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "desktop svelte-niradp");
    			add_location(div0, file, 43, 0, 1226);
    			attr_dev(div1, "class", "mobile svelte-niradp");
    			add_location(div1, file, 47, 0, 1289);
    			attr_dev(h1, "class", "svelte-niradp");
    			add_location(h1, file, 53, 2, 1381);
    			attr_dev(p0, "class", "deck svelte-niradp");
    			add_location(p0, file, 54, 2, 1415);
    			attr_dev(p1, "class", "byline svelte-niradp");
    			add_location(p1, file, 55, 2, 1510);
    			attr_dev(div2, "class", "header svelte-niradp");
    			add_location(div2, file, 52, 1, 1358);
    			add_location(p2, file, 59, 2, 1580);
    			add_location(p3, file, 60, 2, 1666);
    			add_location(p4, file, 61, 2, 2106);
    			add_location(strong0, file, 63, 23, 2327);
    			attr_dev(h20, "class", "svelte-niradp");
    			add_location(h20, file, 63, 2, 2306);
    			attr_dev(div3, "class", "desktop svelte-niradp");
    			add_location(div3, file, 66, 3, 2392);
    			attr_dev(div4, "class", "mobile svelte-niradp");
    			add_location(div4, file, 70, 3, 2459);
    			attr_dev(div5, "class", "legendSVG svelte-niradp");
    			add_location(div5, file, 65, 2, 2365);
    			add_location(strong1, file, 77, 25, 2568);
    			attr_dev(h21, "class", "svelte-niradp");
    			add_location(h21, file, 77, 2, 2545);
    			attr_dev(div6, "class", "desktop svelte-niradp");
    			add_location(div6, file, 80, 3, 2640);
    			attr_dev(div7, "class", "mobile svelte-niradp");
    			add_location(div7, file, 83, 3, 2706);
    			attr_dev(div8, "class", "legendSVG svelte-niradp");
    			add_location(div8, file, 79, 2, 2613);
    			attr_dev(div9, "class", "body svelte-niradp");
    			add_location(div9, file, 58, 1, 1559);
    			attr_dev(h22, "class", "svelte-niradp");
    			add_location(h22, file, 91, 2, 2819);
    			attr_dev(div10, "class", "desktop svelte-niradp");
    			add_location(div10, file, 93, 2, 2918);
    			attr_dev(div11, "class", "mobile svelte-niradp");
    			add_location(div11, file, 97, 2, 2981);
    			add_location(strong2, file, 101, 33, 3082);
    			attr_dev(h23, "class", "svelte-niradp");
    			add_location(h23, file, 101, 2, 3051);
    			attr_dev(p5, "class", "body svelte-niradp");
    			add_location(p5, file, 103, 2, 3165);
    			attr_dev(div12, "class", "desktop svelte-niradp");
    			add_location(div12, file, 105, 2, 3378);
    			attr_dev(div13, "class", "mobile svelte-niradp");
    			add_location(div13, file, 109, 2, 3443);
    			attr_dev(p6, "class", "body svelte-niradp");
    			add_location(p6, file, 113, 2, 3513);
    			attr_dev(p7, "class", "body svelte-niradp");
    			add_location(p7, file, 115, 2, 3726);
    			attr_dev(p8, "class", "body svelte-niradp");
    			add_location(p8, file, 117, 2, 3939);
    			video.controls = true;
    			video.autoplay = true;
    			video.muted = true;
    			...
    			attr_dev(div14, "class", "section2");
    			add_location(div14, file, 90, 1, 2794);
    			attr_dev(main, "class", "svelte-niradp");
